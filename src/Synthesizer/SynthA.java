...
public class SynthA {
    ...
    private int octave = 0, midiCode = 0, volume = 100;
    ...
    public SynthA(){
        try {
            ...
            synthesizer.loadInstrument(instruments[midiCode]);
    ...
    public String getInstrumentName(int midiCode) {
        return instruments[midiCode].getName();
    }
    ...
    private class ThreadMIDI implements Runnable {
        ...
        @Override
        public void run() {
            channels[0].programChange(instruments[midiCode].getPatch().getProgram());
